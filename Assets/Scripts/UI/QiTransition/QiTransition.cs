...
public class QiTransition : MonoBehaviour
{
    [Header("------------------通用设置---------------------")]
    [Header("设置动画刷新方式")]
   ...
   // public string Intro_Out_Parent = "-------------------Out设置---------------------";
    ...
    protected virtual void SetEndData() { }
    protected virtual void SetOutPos() { }
    public virtual void ResetToStartData() { }


    //private void Start()
    //{
    //    if (to_PlayOnStart && to_ReplayOnEnable == false)
    //    {
    ...
    //    else
    //    {
    //        if (tweenerTo.IsPlaying() == false && to_PlayOnStart == true)
    //        {
    //            tweenerTo.Play();
