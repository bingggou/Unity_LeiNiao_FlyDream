...
using Excel.Package.Zip.Encryption;
#endif

using Excel.Package.Zip.Core;
using Excel.Package.Zip.Checksums;
using Excel.Package.Zip.Zip.Compression.Streams;
using Excel.Package.Zip.Zip.Compression;

namespace Excel.Package.Zip.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Excel.Package.Zip.Zip.ZipException">
